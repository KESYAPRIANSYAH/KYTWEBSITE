      ...
      <div className="pt-16 pb-80 sm:pt-24 sm:pb-40 lg:pt-40 lg:pb-48">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:static">
          <div className="sm:max-w-lg">
            <h1 className="text-4xl font font-extrabold tracking-tight text-gray-900 sm:text-6xl">Kesy Cell</h1>
            <p className="mt-4 text-xl text-gray-500">Semua produk segala barang software dan hardware tersedia disini harga bisa nego diskon sampai 100% jangan sampai lupa mampir ke kesy cell, AYOOO!!!!! segera ke Kesy cell.</p>
          </div>
          <div>
            <div className="mt-10">
                  ...
                  <div className="flex items-center space-x-6 lg:space-x-8">
                    <div className="flex-shrink-0 grid grid-cols-1 gap-y-6 lg:gap-y-8">
                      <div className="w-44 h-64 rounded-lg overflow-hidden sm:opacity-0 lg:opacity-100">
                        <img
                          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbL-dnxjUBRkk4dWnlqHo8SsJT8KatewkvQGsPsTAVLNrPz4OttM4LfbzP2eEqyrMbO98&usqp=CAUhttps://tailwindui.com/img/ecommerce-images/home-page-03-hero-image-tile-01.jpg"
                          alt=""
              ...
              <a href="#" className="inline-block text-center bg-indigo-600 border border-transparent rounded-md py-3 px-8 font-medium text-white hover:bg-indigo-700">
                Shop Collection
              </a>
            </div>
          </div>
